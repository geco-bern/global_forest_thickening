...
# WWF Ecoregions data
biomes <- sf::read_sf(here::here("data/biomes/olson_harvard_dataverse/tnc_terr_ecoregions.shp"))
...
terra::writeRaster(
  biomes_raster,
  filename = here::here("data/biomes/biomes_raster_0.1deg.tif"),
  overwrite = TRUE
  )
...
ggsave(here::here("/manuscript/figures/fig_S1euforia.png"), width = 13, height = 8, dpi = 300)

ggsave(here::here("/manuscript/figures/map.pdf"), width = 5, height = 4.5, dpi = 300)

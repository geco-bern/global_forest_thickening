...
# full lqmm at tau = 0.90 (same model family as per-bin)
full_lqmm <- lqmm(logDensity ~ year, random = ~1, group = plotID, tau = 0.90, type = "normal", data = data_unm_biome)
summary(full_lqmm)
...
ggplot(data_fil_biome2) +
  geom_point(aes(x = logQMD, y = logDensity, color = plotID))
...
=======
>>>>>>> 06738a6df2dc9ba4b3f9a54a9d229598fa28afe2

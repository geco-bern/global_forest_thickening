...
To be added as text (and equations) here:

\begin{itemize}
\item How QMD derived if not explicitly provided in obtained dataset. % (From ms: The QMD (cm) was calculated as a function of basal area (m2 ha‐1) and stand density (N, trees ha−1).)
\end{itemize}
...
\caption{Distributions of model slope estimates (year effect) across biomes.}
\end{figure}

...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{../figures/slopefilter.pdf}
\caption{Distributions of model slope estimates (logQMD) across biomes. The red band indicates the range of values of linear regression slopes retained after applying the \textit{slope filter}.}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\textwidth]{../figures/fig_lqmm_byqmdbin_biomes.pdf}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{../figures/distribution_percent_change.pdf}
